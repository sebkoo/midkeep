...
# Cheapest first. gate-arch, gate-hygiene, gate-runners, gate-hostpath and
# gate-address need only a checkout and git, so on a host with no toolchain
# they still reach a verdict while the three toolchain gates report 2.
#
...
GATES="gate-arch gate-hygiene gate-runners gate-hostpath gate-address gate-workflow gate-format gate-build gate-test"
